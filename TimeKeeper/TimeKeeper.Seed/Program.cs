...
namespace TimeKeeper.Seed
{
    class Program
    {
        static TimeKeeperContext context = new TimeKeeperContext();
        ...
        private static void SeedCustomers()
        {
            ...
            foreach (DataRow row in rawData.Rows)
            {
                ...
                Customer customer = new Customer()
                {
                    ...
                    Address = new Address()
                    {
                        Name = (string)row.Read(6, typeof(string)),
                        ZipCode=(string)row.Read(7, typeof(string)),
                        City = (string)row.Read(8, typeof(string))
                    },
                    StatusCustomer = (StatusCustomer)row.Read(9, typeof(int))
                };
        ...
        private static void SeedProjects()
        {
            ...
            foreach (DataRow row in rawData.Rows)
            {
                ...
                Project project = new Project()
                {
                    ...
                    StatusProject = (StatusProject)row.Read(6, typeof(int)),
                    ...
                    Pricing = (Pricing)row.Read(9, typeof(int)),
